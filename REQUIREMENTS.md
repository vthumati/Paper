...
- **FR-T-3 (M)** ✅ Unified per-entity dashboard: cap table, fundraising, compliance (incl. overdue), ESOP, governance, documents, data rooms — plus a fund block for fund entities. Default landing tab.
